      ...
      <div className="about__container">
        ...
        <div className="about__text">
          ...
          <p className="about__description">
            ...
            разработчик. Окончил курс фронтенд-разработчик в Яндекс.Практикуме.
            Изучил HTML, CSS, JavaScript, Webpack, а так же работу с GitHub
          </p>
          <p className="about__description">
            ...
            системах, асинхронным запросам к серверу. Было выполненно несколько
            самостоятельных проектов, каждый проект проходил ревью у
